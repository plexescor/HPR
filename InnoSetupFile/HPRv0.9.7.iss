...
OutputDir=C:\HPR\INNO\v0.9.8
OutputBaseFilename=HPRv0.9.8
SetupIconFile=C:\HPR\v0.9.8\assets\icon.ico
...
[Files]
; -- App binaries --
Source: "C:\HPR\v0.9.8\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\HPR\v0.9.8\slint_cpp.dll"; DestDir: "{app}"; Flags: ignoreversion

; -- aliases.csv and config.csv: Pascal handles overwrite logic --
Source: "C:\HPR\v0.9.8\aliases.csv"; DestDir: "{userappdata}\HPR\HPR_Config"; Flags: ignoreversion; Check: ShouldCopyAliases
Source: "C:\HPR\v0.9.8\tabAliases.csv"; DestDir: "{userappdata}\HPR\HPR_Config"; Flags: ignoreversion; Check: ShouldCopyTabAliases
Source: "C:\HPR\v0.9.8\config.csv"; DestDir: "{userappdata}\HPR\HPR_Config"; Flags: ignoreversion; Check: ShouldCopyConfig
Source: "C:\HPR\v0.9.8\projectAliases.csv"; DestDir: "{userappdata}\HPR\HPR_Config"; Flags: ignoreversion; Check: ShouldCopyProjectAliases

; -- assets: always silently overwrite --
Source: "C:\HPR\v0.9.8\assets\*"; DestDir: "{userappdata}\HPR\HPR_Config\assets"; Flags: ignoreversion recursesubdirs createallsubdirs

; -- ui-REFERENCEONLY: always silently overwrite --
Source: "C:\HPR\v0.9.8\ui\*"; DestDir: "{userappdata}\HPR\HPR_Config\ui-REFERENCEONLY"; Flags: ignoreversion recursesubdirs createallsubdirs

; -- ui: BeforeInstall deletes folder if user confirmed, onlyifdoesntexist skips if user said no --
Source: "C:\HPR\v0.9.8\ui\*"; DestDir: "{userappdata}\HPR\HPR_Config\ui"; Flags: ignoreversion recursesubdirs createallsubdirs onlyifdoesntexist; BeforeInstall: DeleteUIIfConfirmed
