...
namespace NativeNet
{
    ...
    std::pair<std::string, int> httpPut(const std::string& host, const std::string& path, const std::string& body, bool secure = true, const std::map<std::string, std::string>& headers = {});
    std::pair<std::string, int> httpDelete(const std::string& host, const std::string& path, bool secure = true, const std::map<std::string, std::string>& headers = {});
