...
**Requirements:** Windows 10/11 
                  Linux (Clang or GCC) currently hyprland is supported
                  MSVC (though mingw with windows.h support works)
                  Cmake

## Building From Source
```bash
1- git clone https://github.com/plexescor/HPR
2- cd HPR
...
HPR uses native OS hooks (On Windows) and system commands (On Linux) to detect the active window and tracks time automatically.
...
|:------:|:---:|:-------------:|:----------:|:-----:|
| **Size** | 4 MB | 200 MB+ | Cloud-based | Cloud-based |
| **RAM Usage** | < 30 MB | 200 MB+ | N/A | N/A |
...
A: Currently Windows and Linux. MacOS in future

**Q: Is this really free?**  
A: Yes. Though the advances/premium version requires 💲💲💲
...
**Status:** Early development (v0.1) - Functional but rough around the edges.  
**Platform:** Windows 10/11  
**Dependencies:** Slint UI Framework
                  SQLite (included)
